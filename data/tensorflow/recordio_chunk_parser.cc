...
Status ChunkParser::ReadNBytes(std::unique_ptr<InputStreamInterface> &input_stream,
                         uint64 offset,
                         size_t n,
                         string* result) {
...
Status ChunkParser::Parse(std::unique_ptr<InputStreamInterface> &input_stream,
                    uint64* offset,
